...
public class DebateResultDto {
  ...
  private int sideARate; // A측 비율
  private int sideBCRate; // B측 비율
  ...
  public static class AiSummaryResultDto {
    ...
    private static final String FAILURE_MSG = "AI 요약 실패.";
    ...
    public static AiSummaryResultDto failure() {
      return new AiSummaryResultDto(FAILURE_MSG, FAILURE_MSG, FAILURE_MSG);
    }
  }

  public DebateResultDto(DebateType debateType, String title, String categoryName,
      String sideA, String sideB, String aiSummaryResult, Long durationSeconds,
      int sideARate, int sideBCRate, Long totalCount) {
